...
function perzonalizarTema($wp_customize){
	...
	// Section para Google
	$wp_customize->add_panel( 'google_settings_panel', array(
		'title' => 'Configuraciones de Google',
		'priority' => 21,
	...
	$wp_customize->add_section( 'google_analytics_section' , array(
		...
		'description' => 'Sección para agregar codigo de Analytics',
		'panel'	=> 'google_settings_panel',
		'priority' => 1,
		'capability' => 'edit_theme_options',
	));
	...
	//AdSense
	$wp_customize->add_section( 'google_adsense_section' , array(
		'title' => 'Google AdSense',
		'description' => 'Sección para agregar codigos de los anuncios de AdSense. Para agregar anuncios en cualquier post o pagina usa el shortcode [googleAdsense]',
		'panel'	=> 'google_settings_panel',
		'priority' => 2,
		'capability' => 'edit_theme_options',
	));
	$wp_customize->add_setting( 'google_adsense_728_90', array(
		'type' => 'theme_mod',
		'capability' => 'edit_theme_options',
	));
	$wp_customize->add_control('google_adsense_728_90', array(
		'label' => 'Código de Anuncios 728x90',
		'section' => 'google_adsense_section',
		'priority' => 1,
		'type' => 'textarea',
	));
	$wp_customize->add_setting( 'google_adsense_336_280', array(
		'type' => 'theme_mod',
		'capability' => 'edit_theme_options',
	));
	$wp_customize->add_control('google_adsense_336_280', array(
		'label' => 'Código de Anuncios 336x280',
		'section' => 'google_adsense_section',
		'priority' => 2,
		'type' => 'textarea',
	));
	$wp_customize->add_setting( 'google_adsense_300_250', array(
		'type' => 'theme_mod',
		'capability' => 'edit_theme_options',
	));
	$wp_customize->add_control('google_adsense_300_250', array(
		'label' => 'Código de Anuncios 300x250',
		'section' => 'google_adsense_section',
		'priority' => 2,
		'type' => 'textarea',
	));
	// Fin Section para Google
	// Section Carrousel
	...
	$wp_customize->add_control(new Category_Dropdown_Custom_control($wp_customize, 'carrousel_header',
	array(
	...
	$wp_customize->add_section( 'redes_sociales_section' , array(
		...
		'description' 	=> 'Sección para agregar link de tus redes sociales',
		'priority' 		=> 24,
		'capability' 	=> 'edit_theme_options',
	));
	...
	// Fin Section Redes Sociales
	//Section tarjetas principales
	$wp_customize->add_section( 'tarjetas_servicios_section' , array(
		'title' 		=> 'Tarjetas Servicios',
		'description' 	=> 'Sección para agregar escoger las paginas que se colocaran en las tarjetas de servicios',
		'priority' 		=> 25,
		'capability' 	=> 'edit_theme_options',
	));
	...
	$wp_customize->add_control('tarjetas_servicios_1', array(
		'label' => 'Tarjeta 1',
	...
	$wp_customize->add_control('tarjetas_servicios_2', array(
		'label' => 'Tarjeta 2',
		'section' => 'tarjetas_servicios_section',
		'priority' => 2,
		'type' => 'dropdown-pages',
	...
	$wp_customize->add_control('tarjetas_servicios_3', array(
		'label' => 'Tarjeta 3',
		'section' => 'tarjetas_servicios_section',
		'priority' => 3,
		'type' => 'dropdown-pages',
	...
	$wp_customize->add_section( 'blog_section' , array(
		'title' 		=> 'Blog',
		'description' 	=> 'Configura la sección de Blog',
		'priority' 		=> 26,
		'capability' 	=> 'edit_theme_options',
	));
	...
	// Setting - drop down category for slider.
	$wp_customize->add_control(new Category_Dropdown_Custom_control($wp_customize, 'blog_catgegory',
	array(
	    'label'       => 'Seleccion de categorias',
	...
	// Setting - drop down category for slider.
	$wp_customize->add_control(new TagsCloud_Dropdown_Custom_control($wp_customize, 'tag_cloud',
	array(
	...
	$wp_customize->add_section( 'call_to_action_section' , array(
		...
		'description' 	=> 'Sección para escoger las llamadas a la acción que apareceran en tu página. Tambien podras posicionar estos botones en cualquier pagina o entrada usando el shortcode [callToAction]',
		'priority' 		=> 29,
		'capability' 	=> 'edit_theme_options',
	));
	//Boton 1
